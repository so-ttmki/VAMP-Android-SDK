...
//        addLog(getIndex(placementId), "onReceive(" + placementId + ":" + adnwName + ")");
    ...
    public void onFailedToLoad(VAMPError vampError, VAMPAd vampAd) {
        ...
        String placementId = vampAd.getPlacementId();
        addLog(getIndex(placementId), "onFailedToLoad(" + placementId + ") " + vampError, Color.RED);
    ...
    public void onFailedToShow(VAMPError vampError, VAMPAd vampAd) {
        ...
        String placementId = vampAd.getPlacementId();
        addLog(getIndex(placementId), "onFailedToShow(" + placementId + ") " + vampError, Color.RED);
    ...
    public void onOpen(VAMPAd vampAd) {
        ...
        addLog("[Ad1] onOpen(" + vampAd.getAdnwName() + ")", Color.BLACK);
    }
    ...
    public void onClose(VAMPAd vampAd, boolean adClicked) {
        ...
        String placementId = vampAd.getPlacementId();
        String adnwName = vampAd.getAdnwName();
        addLog(getIndex(placementId), "onClose(" + placementId + ":" + adnwName + ", Click:" + adClicked + ")", Color.BLACK);
    }
